...
function install() {
  ...
  export PREFIX
  $PREFIX curl python3-pip vim git build-essential zlib1g-dev unzip libffi-dev libssl-dev libbz2-dev ncurses-dev libreadline-dev tk-dev lzma-dev tree ripgrep vim zsh jq
  ...
  install_from_asdf kubectl 1.28.1
  install_krew
